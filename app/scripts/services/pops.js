...
angular.module('popmap').service('pops', ['$q',function($q){
  ...
  api.pops = {
    ny: { short: 'NY', name: 'New York', address: '111 8th Ave, New York, NY 10011', color: '52779a'},
    dc: { short: 'DC', name: 'Washington', address: '21715 Filigree Ct., Ashburn VA 20147', color: 'aaaaaa'},
    atl: { short: 'ATL', name: 'Atlanta', address: '56 Marietta St., Atlanta, GA 30303', color: 'cc223c'},
    dal: { short: 'DAL', name: 'Dallas', address: '1950 N Stemmons Fwy, Dallas, TX 75207', color: '0972b4'},
    ...
    chi: { short: 'CHI', name: 'Chicago', address: '350 E Cermak Rd, Chicago, IL 60616', color: '4ab9e6'},
